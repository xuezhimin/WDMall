...
public class PzshAdapter extends RecyclerView.Adapter<PzshAdapter.MyViewHolder> {
    ...
    public PzshAdapter(Context mContext) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View inflate = LayoutInflater.from(mContext).inflate(R.layout.goods_pzsh_item, viewGroup, false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.goods_pzsh_img);
            txtTitle = itemView.findViewById(R.id.goods_pzsh_title);
            txtPrice = itemView.findViewById(R.id.goods_pzsh_price);
        }
    }
