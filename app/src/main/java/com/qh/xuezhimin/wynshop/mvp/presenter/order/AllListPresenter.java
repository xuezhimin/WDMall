...
public class AllListPresenter extends BasePresenter {


    public AllListPresenter(DataCall dataCall) {
        super(dataCall);
    }
    ...
    protected Observable observable(Object... args) {
        ...
        return requestInterFace.queryAllOrder((long) args[0], (String) args[1],
