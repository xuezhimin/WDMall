...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.goods_order_comment_four_item, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.image.setImageURI(Uri.parse(images[0]));
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            image = itemView.findViewById(R.id.order_comment_goods_item_img);
            txtTitle = itemView.findViewById(R.id.order_comment_goods_item_title);
            txtprice = itemView.findViewById(R.id.order_comment_goods_item_price);
        }
    }
