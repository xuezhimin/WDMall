...
public class MlssAdapter extends RecyclerView.Adapter<MlssAdapter.MyViewHolder> {
    ...
    public MlssAdapter(Context mContext) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.goods_mlss_item, viewGroup, false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            imageView = itemView.findViewById(R.id.goods_mlss_img);
            txtTitle = itemView.findViewById(R.id.goods_mlss_title);
            txtPrice = itemView.findViewById(R.id.goods_mlss_price);
        }
    }
