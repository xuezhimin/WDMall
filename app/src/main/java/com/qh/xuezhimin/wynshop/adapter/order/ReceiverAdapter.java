...
public class ReceiverAdapter extends RecyclerView.Adapter<ReceiverAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.goods_order_receiver_three_item, viewGroup, false);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            image = itemView.findViewById(R.id.order_receiver_goods_item_img);
            txtTitle = itemView.findViewById(R.id.order_receiver_goods_item_title);
            txtprice = itemView.findViewById(R.id.order_receiver_goods_item_price);
        }
    }
